...
export default function CreateTailgate(props) {
  ...
  return (
    <div className = "contain">
      ...
      <div className = "left">
        <h4>Tailgate Name</h4>
        <input type="text" ref={tailgate_name} placeholder="Tailgate Name" name="tailgate_name" id="tailgate_name"/> 
        <h4>Tailgate Location</h4>
        <select ref={tailgate_loc} name="tailgate_loc" value="Location" id="tailgate_loc">
        ...
        <input ref={num_guests} style={{width:"75px"}}type="number" name="num_guests" step="1" placeholder="20"></input>
        <h4>Short Description</h4>
        <input ref={short_desc} type="text" style={{width:500,height:175}} name="short_desc" id="short_desc"/> 
        <h4>More Info</h4>
        <input ref={more_info} type="text" style={{width:500,height:175}} name="more_info" id="more_info"/> 
    </div>
    <input type="button" class="button" value="Submit" onClick={(e) => handleCreate(e)} /> {/* Do something to submit data */}
    </div>
  );
}
